...
#[cfg_attr(
    ...
    garde(custom(crate::validation::v202607::validate_zeitraum))
)]
...
///
/// > **Note:** [Zeitraum JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Zeitraum.json)
pub struct Zeitraum {
    ...
    /// BO4E type discriminant — always `ComTyp::Zeitraum` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Zeitraum), setter(skip))
    )]
...
impl Default for Zeitraum {
    fn default() -> Self {
        Self {
            dauer: Default::default(),
            enddatum: Default::default(),
            enduhrzeit: Default::default(),
            id: Default::default(),
            startdatum: Default::default(),
            startuhrzeit: Default::default(),
            typ: Some(ComTyp::Zeitraum),
...
impl Bo4eTyped for Zeitraum {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Zeitraum;
    const TYP_WIRE: &'static str = "ZEITRAUM";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Zeitraum {}
impl Bo4eComponent for Zeitraum {}
impl crate::bo4e_component_sealed::Sealed for Zeitraum {}
#[cfg(feature = "json")]
...
impl crate::Bo4eStrict for Zeitraum {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Zeitraum {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Zeitraum {
