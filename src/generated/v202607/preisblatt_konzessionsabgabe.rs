...
impl Default for PreisblattKonzessionsabgabe {
    fn default() -> Self {
        Self {
            ...
            id: Default::default(),
            kundengruppe_ka: Default::default(),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for PreisblattKonzessionsabgabe {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl std::fmt::Display for PreisblattKonzessionsabgabe {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => {
                write!(f, "<PreisblattKonzessionsabgabe: serialization error: {e}>")
            }
        }
    }
}
impl crate::Bo4eStrict for PreisblattKonzessionsabgabe {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(v) = &self.kundengruppe_ka {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "kundengruppeKA"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for PreisblattKonzessionsabgabe {
...
impl crate::zusatz_attribut::HasZusatzAttribute for PreisblattKonzessionsabgabe {
