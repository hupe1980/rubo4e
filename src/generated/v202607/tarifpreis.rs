use super::{
    Bo4eComponent, Bo4eTyped, ComTyp, Mengeneinheit, Preisstatus, Preistyp, Waehrungseinheit,
    ZusatzAttribut,
};
...
///
/// > **Note:** [Tarifpreis JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Tarifpreis.json)
pub struct Tarifpreis {
    ...
    /// BO4E type discriminant — always `ComTyp::Tarifpreis` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Tarifpreis), setter(skip))
    )]
...
impl Default for Tarifpreis {
    fn default() -> Self {
        Self {
            beschreibung: Default::default(),
            bezugswert: Default::default(),
            einheit: Default::default(),
            id: Default::default(),
            preistyp: Default::default(),
            status: Default::default(),
            typ: Some(ComTyp::Tarifpreis),
...
impl Bo4eTyped for Tarifpreis {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Tarifpreis;
    const TYP_WIRE: &'static str = "TARIFPREIS";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Tarifpreis {}
impl Bo4eComponent for Tarifpreis {}
impl crate::bo4e_component_sealed::Sealed for Tarifpreis {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Tarifpreis {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Tarifpreis {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Tarifpreis {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Tarifpreis {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Tarifpreis: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Tarifpreis {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(v) = &self.status {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "status"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Tarifpreis {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Tarifpreis {
