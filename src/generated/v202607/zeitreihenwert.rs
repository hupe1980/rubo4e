...
///
/// > **Note:** [Zeitreihenwert JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Zeitreihenwert.json)
pub struct Zeitreihenwert {
    ...
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub status: Option<Messwertstatus>,
    /// Eine Zusatzinformation zum Status, beispielsweise ein Grund für einen fehlenden Wert.
    #[cfg_attr(feature = "serde", serde(rename = "statuszusatz"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub statuszusatz: Option<Messwertstatuszusatz>,
    /// BO4E type discriminant — always `ComTyp::Zeitreihenwert` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Zeitreihenwert), setter(skip))
    )]
...
impl Default for Zeitreihenwert {
    fn default() -> Self {
        Self {
            id: Default::default(),
            status: Default::default(),
            statuszusatz: Default::default(),
            typ: Some(ComTyp::Zeitreihenwert),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Zeitreihenwert {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Zeitreihenwert {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Zeitreihenwert {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Zeitreihenwert: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Zeitreihenwert {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(v) = &self.statuszusatz {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "statuszusatz"),
                out,
            );
        }
        if let Some(v) = &self.zeitraum {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "zeitraum"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Zeitreihenwert {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Zeitreihenwert {
