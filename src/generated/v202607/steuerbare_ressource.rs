...
///
/// > **Note:** [SteuerbareRessource JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/bo/SteuerbareRessource.json)
pub struct SteuerbareRessource {
    ...
    /// BO4E type discriminant — always `BoTyp::SteuerbareRessource` for this struct.
...
impl crate::Bo4eStrict for SteuerbareRessource {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(v) = &self.steuerkanal_leistungsbeschreibung {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "steuerkanalLeistungsbeschreibung"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for SteuerbareRessource {
...
impl crate::zusatz_attribut::HasZusatzAttribute for SteuerbareRessource {
