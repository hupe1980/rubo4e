use super::{Bo4eComponent, Bo4eTyped, ComTyp, Zaehlzeittagtyp, ZusatzAttribut};
...
impl Bo4eTyped for Zaehlzeitsaison {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Zaehlzeitsaison;
    const TYP_WIRE: &'static str = "ZAEHLZEITSAISON";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Zaehlzeitsaison {}
impl Bo4eComponent for Zaehlzeitsaison {}
impl crate::bo4e_component_sealed::Sealed for Zaehlzeitsaison {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Zaehlzeitsaison {
