...
pub struct Zaehler {
    ...
    /// Fernauslesung
    #[cfg_attr(feature = "serde", serde(rename = "istFernauslesbar"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
...
impl Default for Zaehler {
    fn default() -> Self {
        Self {
            ...
            id: Default::default(),
            ist_fernauslesbar: Default::default(),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Zaehler {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Zaehler {
