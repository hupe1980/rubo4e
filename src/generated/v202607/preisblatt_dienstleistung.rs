use super::{
    ...
    Marktteilnehmer, Preisposition, Preisstatus, Sparte, Zeitraum, ZusatzAttribut,
};
...
///
/// > **Note:** [PreisblattDienstleistung JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/bo/PreisblattDienstleistung.json)
pub struct PreisblattDienstleistung {
    /// Dienstleistung, für die der Preis abgebildet wird, z.B. Sperrung/Entsperrung
    #[cfg_attr(feature = "serde", serde(rename = "basisdienstleistung"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub basisdienstleistung: Option<Dienstleistungstyp>,
    ...
    #[cfg_attr(feature = "serde", serde(rename = "geraetedetails"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    #[cfg_attr(feature = "validate", garde(dive))]
    pub geraetedetails: Option<Box<Geraet>>,
    ...
    /// BO4E type discriminant — always `BoTyp::PreisblattDienstleistung` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(BoTyp::PreisblattDienstleistung), setter(skip))
    )]
...
impl Default for PreisblattDienstleistung {
    fn default() -> Self {
        Self {
            basisdienstleistung: Default::default(),
            bezeichnung: Default::default(),
            bilanzierungsmethode: Default::default(),
            geraetedetails: Default::default(),
            ...
            typ: Some(BoTyp::PreisblattDienstleistung),
...
impl Bo4eTyped for PreisblattDienstleistung {
    type Typ = BoTyp;
    const TYP: BoTyp = BoTyp::PreisblattDienstleistung;
    const TYP_WIRE: &'static str = "PREISBLATTDIENSTLEISTUNG";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for PreisblattDienstleistung {}
impl Bo4eObject for PreisblattDienstleistung {}
impl crate::bo4e_object_sealed::Sealed for PreisblattDienstleistung {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for PreisblattDienstleistung {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for PreisblattDienstleistung {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for PreisblattDienstleistung {
...
#[cfg(feature = "json")]
impl std::fmt::Display for PreisblattDienstleistung {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<PreisblattDienstleistung: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for PreisblattDienstleistung {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        if let Some(v) = &self.basisdienstleistung {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "basisdienstleistung"),
                out,
            );
        }
        ...
        if let Some(v) = &self.geraetedetails {
            crate::Bo4eStrict::collect_unknown_enums(
                &**v,
                &crate::strict::field_path(path, "geraetedetails"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for PreisblattDienstleistung {
...
impl crate::zusatz_attribut::HasZusatzAttribute for PreisblattDienstleistung {
