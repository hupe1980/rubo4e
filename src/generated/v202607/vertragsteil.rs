use super::{Bo4eComponent, Bo4eTyped, ComTyp, Menge, ZusatzAttribut};
...
///
/// > **Note:** [Vertragsteil JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Vertragsteil.json)
pub struct Vertragsteil {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "lokation"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    ...
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Vertragsteil), setter(skip))
    )]
...
impl Bo4eTyped for Vertragsteil {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Vertragsteil;
    const TYP_WIRE: &'static str = "VERTRAGSTEIL";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Vertragsteil {}
impl Bo4eComponent for Vertragsteil {}
impl crate::bo4e_component_sealed::Sealed for Vertragsteil {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Vertragsteil {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Vertragsteil {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Vertragsteil {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Vertragsteil {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Vertragsteil: serialization error: {e}>"),
        }
    }
}
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Vertragsteil {
