...
pub struct Zaehlzeitregister {
    ...
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub zaehlzeit_definition: Option<String>,
    /// Zählzeitregister
    #[cfg_attr(feature = "serde", serde(rename = "zaehlzeitRegister"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub zaehlzeit_register: Option<String>,
...
impl Default for Zaehlzeitregister {
    fn default() -> Self {
        Self {
            id: Default::default(),
...
impl Bo4eTyped for Zaehlzeitregister {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Zaehlzeitregister;
    const TYP_WIRE: &'static str = "ZAEHLZEITREGISTER";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Zaehlzeitregister {}
impl Bo4eComponent for Zaehlzeitregister {}
impl crate::bo4e_component_sealed::Sealed for Zaehlzeitregister {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Zaehlzeitregister {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Zaehlzeitregister {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Zaehlzeitregister {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Zaehlzeitregister {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Zaehlzeitregister: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Zaehlzeitregister {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Zaehlzeitregister {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Zaehlzeitregister {
