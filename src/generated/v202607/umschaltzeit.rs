...
///
/// > **Note:** [Umschaltzeit JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Umschaltzeit.json)
pub struct Umschaltzeit {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "registercode"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub registercode: Option<String>,
    /// BO4E type discriminant — always `ComTyp::Umschaltzeit` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Umschaltzeit), setter(skip))
    )]
    ...
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub umschaltzeit: Option<String>,
...
impl Default for Umschaltzeit {
    fn default() -> Self {
        Self {
            id: Default::default(),
            registercode: Default::default(),
            typ: Some(ComTyp::Umschaltzeit),
            umschaltzeit: Default::default(),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Umschaltzeit {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Umschaltzeit {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Umschaltzeit {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Umschaltzeit: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Umschaltzeit {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Umschaltzeit {
