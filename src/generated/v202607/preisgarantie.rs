use super::{Bo4eComponent, Bo4eTyped, ComTyp, Preisgarantietyp, Zeitraum, ZusatzAttribut};
...
pub struct Preisgarantie {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "preisgarantietyp"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
...
impl Default for Preisgarantie {
    fn default() -> Self {
        Self {
...
impl Bo4eTyped for Preisgarantie {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Preisgarantie;
    const TYP_WIRE: &'static str = "PREISGARANTIE";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Preisgarantie {}
impl Bo4eComponent for Preisgarantie {}
impl crate::bo4e_component_sealed::Sealed for Preisgarantie {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Preisgarantie {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Preisgarantie {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Preisgarantie {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Preisgarantie {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Preisgarantie: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Preisgarantie {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        if let Some(v) = &self.preisgarantietyp {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "preisgarantietyp"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Preisgarantie {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Preisgarantie {
