use super::{
    Adresse, Anrede, Bo4eObject, Bo4eTyped, BoTyp, Kontaktweg, Titel, ZusatzAttribut,
    Zustaendigkeit,
};
...
impl Bo4eTyped for Person {
    type Typ = BoTyp;
    const TYP: BoTyp = BoTyp::Person;
    const TYP_WIRE: &'static str = "PERSON";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Person {}
...
impl crate::Bo4eStrict for Person {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(items) = &self.zustaendigkeiten {
            let child = crate::strict::field_path(path, "zustaendigkeiten");
            for (i, item) in items.iter().enumerate() {
                crate::Bo4eStrict::collect_unknown_enums(
                    item,
                    &crate::strict::index_path(&child, i),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Person {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Person {
