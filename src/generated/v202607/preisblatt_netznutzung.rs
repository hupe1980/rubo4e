...
impl crate::Bo4eStrict for PreisblattNetznutzung {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        ...
        if let Some(v) = &self.kundengruppe {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "kundengruppe"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for PreisblattNetznutzung {
...
impl crate::zusatz_attribut::HasZusatzAttribute for PreisblattNetznutzung {
