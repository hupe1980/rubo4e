...
impl Bo4eTyped for StandorteigenschaftenStrom {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::StandorteigenschaftenStrom;
    const TYP_WIRE: &'static str = "STANDORTEIGENSCHAFTENSTROM";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for StandorteigenschaftenStrom {}
impl Bo4eComponent for StandorteigenschaftenStrom {}
impl crate::bo4e_component_sealed::Sealed for StandorteigenschaftenStrom {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for StandorteigenschaftenStrom {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for StandorteigenschaftenStrom {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for StandorteigenschaftenStrom {
...
#[cfg(feature = "json")]
impl std::fmt::Display for StandorteigenschaftenStrom {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<StandorteigenschaftenStrom: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for StandorteigenschaftenStrom {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for StandorteigenschaftenStrom {
...
impl crate::zusatz_attribut::HasZusatzAttribute for StandorteigenschaftenStrom {
