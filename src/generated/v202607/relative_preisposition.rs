...
///
/// > **Note:** [RelativePreisposition JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/RelativePreisposition.json)
pub struct RelativePreisposition {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "idReferenz"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub id_referenz: Option<String>,
    /// BO4E type discriminant — always `ComTyp::RelativePreisposition` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::RelativePreisposition), setter(skip))
    )]
...
impl Default for RelativePreisposition {
    fn default() -> Self {
        Self {
            ...
            typ: Some(ComTyp::RelativePreisposition),
...
impl Bo4eTyped for RelativePreisposition {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::RelativePreisposition;
    const TYP_WIRE: &'static str = "RELATIVEPREISPOSITION";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for RelativePreisposition {}
impl Bo4eComponent for RelativePreisposition {}
impl crate::bo4e_component_sealed::Sealed for RelativePreisposition {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for RelativePreisposition {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for RelativePreisposition {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for RelativePreisposition {
...
#[cfg(feature = "json")]
impl std::fmt::Display for RelativePreisposition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<RelativePreisposition: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for RelativePreisposition {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for RelativePreisposition {
...
impl crate::zusatz_attribut::HasZusatzAttribute for RelativePreisposition {
