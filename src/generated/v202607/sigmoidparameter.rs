...
/// LP=A/(1+(P/B)^C)+D
///
/// > **Note:** [Sigmoidparameter JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Sigmoidparameter.json)
pub struct Sigmoidparameter {
    ...
    /// BO4E type discriminant — always `ComTyp::Sigmoidparameter` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Sigmoidparameter), setter(skip))
    )]
...
impl Default for Sigmoidparameter {
    fn default() -> Self {
        Self {
            a: Default::default(),
            b: Default::default(),
            ...
            d: Default::default(),
            id: Default::default(),
            typ: Some(ComTyp::Sigmoidparameter),
...
impl Bo4eTyped for Sigmoidparameter {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Sigmoidparameter;
    const TYP_WIRE: &'static str = "SIGMOIDPARAMETER";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Sigmoidparameter {}
impl Bo4eComponent for Sigmoidparameter {}
impl crate::bo4e_component_sealed::Sealed for Sigmoidparameter {}
#[cfg(feature = "json")]
...
impl crate::Bo4eStrict for Sigmoidparameter {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Sigmoidparameter {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Sigmoidparameter {
