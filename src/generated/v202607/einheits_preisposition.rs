use super::{Bo4eComponent, Bo4eTyped, ComTyp, Preis, Preisreferenz, ZusatzAttribut};
...
impl Default for EinheitsPreisposition {
    fn default() -> Self {
        Self {
...
impl Bo4eTyped for EinheitsPreisposition {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::EinheitsPreisposition;
    const TYP_WIRE: &'static str = "EINHEITSPREISPOSITION";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for EinheitsPreisposition {}
impl Bo4eComponent for EinheitsPreisposition {}
impl crate::bo4e_component_sealed::Sealed for EinheitsPreisposition {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for EinheitsPreisposition {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for EinheitsPreisposition {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for EinheitsPreisposition {
...
#[cfg(feature = "json")]
impl std::fmt::Display for EinheitsPreisposition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<EinheitsPreisposition: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for EinheitsPreisposition {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for EinheitsPreisposition {
...
impl crate::zusatz_attribut::HasZusatzAttribute for EinheitsPreisposition {
