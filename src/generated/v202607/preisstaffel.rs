use super::{Bo4eComponent, Bo4eTyped, ComTyp, Sigmoidparameter, ZusatzAttribut};
...
impl Bo4eTyped for Preisstaffel {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Preisstaffel;
    const TYP_WIRE: &'static str = "PREISSTAFFEL";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Preisstaffel {}
impl Bo4eComponent for Preisstaffel {}
impl crate::bo4e_component_sealed::Sealed for Preisstaffel {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Preisstaffel {
