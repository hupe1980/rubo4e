use super::{Betrag, Bo4eComponent, Bo4eTyped, ComTyp, Kostenposition, ZusatzAttribut};
...
///
/// > **Note:** [Kostenblock JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Kostenblock.json)
pub struct Kostenblock {
    ...
    pub kostenpositionen: Option<Vec<Kostenposition>>,
    ...
    /// BO4E type discriminant — always `ComTyp::Kostenblock` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Kostenblock), setter(skip))
    )]
...
impl Bo4eTyped for Kostenblock {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Kostenblock;
    const TYP_WIRE: &'static str = "KOSTENBLOCK";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Kostenblock {}
impl Bo4eComponent for Kostenblock {}
impl crate::bo4e_component_sealed::Sealed for Kostenblock {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Kostenblock {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Kostenblock {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Kostenblock {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Kostenblock {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Kostenblock: serialization error: {e}>"),
        }
    }
}
impl crate::Bo4eStrict for Kostenblock {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Kostenblock {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Kostenblock {
