...
///
/// > **Note:** [Fremdkostenposition JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Fremdkostenposition.json)
pub struct Fremdkostenposition {
    ...
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    #[cfg_attr(feature = "validate", garde(dive))]
    pub gebietcode_eic: Option<crate::identifiers::EicCode>,
    ...
    #[cfg_attr(feature = "serde", serde(rename = "linkPreisblatt"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub link_preisblatt: Option<String>,
    /// Die Codenummer (z.B. BDEW-Codenummer) des Marktpartners, der die Preise festlegt / die Kosten in Rechnung stellt
    #[cfg_attr(feature = "serde", serde(rename = "marktpartnercode"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub marktpartnercode: Option<String>,
    /// Der Name des Marktpartners, der die Preise festlegt, bzw. die Kosten in Rechnung stellt
    #[cfg_attr(feature = "serde", serde(rename = "marktpartnername"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub marktpartnername: Option<String>,
    ...
    /// BO4E type discriminant — always `ComTyp::Fremdkostenposition` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Fremdkostenposition), setter(skip))
    )]
...
impl Default for Fremdkostenposition {
    fn default() -> Self {
        Self {
            ...
            gebietcode_eic: Default::default(),
            id: Default::default(),
            link_preisblatt: Default::default(),
            marktpartnercode: Default::default(),
            marktpartnername: Default::default(),
            menge: Default::default(),
            positionstitel: Default::default(),
            typ: Some(ComTyp::Fremdkostenposition),
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Fremdkostenposition {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Fremdkostenposition {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Fremdkostenposition {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Fremdkostenposition: serialization error: {e}>"),
        }
    }
}
...
impl crate::zusatz_attribut::HasZusatzAttribute for Fremdkostenposition {
