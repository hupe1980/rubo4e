use super::{Bo4eObject, Bo4eTyped, BoTyp, Regionsoperation, ZusatzAttribut};
...
impl Bo4eTyped for Region {
    type Typ = BoTyp;
    const TYP: BoTyp = BoTyp::Region;
    const TYP_WIRE: &'static str = "REGION";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Region {}
...
impl crate::Bo4eStrict for Region {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        if let Some(items) = &self.regionsoperationen {
            let child = crate::strict::field_path(path, "regionsoperationen");
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Region {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Region {
