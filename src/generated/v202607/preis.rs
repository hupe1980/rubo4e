use super::{
    Bo4eComponent, Bo4eTyped, ComTyp, Mengeneinheit, Preisstatus, Waehrungseinheit, ZusatzAttribut,
};
...
impl Bo4eTyped for Preis {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Preis;
    const TYP_WIRE: &'static str = "PREIS";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Preis {}
impl Bo4eComponent for Preis {}
impl crate::bo4e_component_sealed::Sealed for Preis {}
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for Preis {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Preis {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for Preis {
...
#[cfg(feature = "json")]
impl std::fmt::Display for Preis {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Preis: serialization error: {e}>"),
        }
    }
}
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Preis {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Preis {
