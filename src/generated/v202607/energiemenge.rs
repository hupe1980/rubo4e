use super::{Bo4eObject, Bo4eTyped, BoTyp, Menge, Zeitraum, ZusatzAttribut};
...
impl Bo4eTyped for Energiemenge {
    type Typ = BoTyp;
    const TYP: BoTyp = BoTyp::Energiemenge;
    const TYP_WIRE: &'static str = "ENERGIEMENGE";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Energiemenge {}
...
impl crate::Bo4eStrict for Energiemenge {
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Energiemenge {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Energiemenge {
