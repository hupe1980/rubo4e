...
///
/// > **Note:** [Vorauszahlung JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202607.1.0/src/bo4e_schemas/com/Vorauszahlung.json)
pub struct Vorauszahlung {
    ...
    /// BO4E type discriminant — always `ComTyp::Vorauszahlung` for this struct.
    #[cfg_attr(feature = "serde", serde(rename = "_typ"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(ComTyp::Vorauszahlung), setter(skip))
    )]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Vorauszahlung {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Vorauszahlung {
