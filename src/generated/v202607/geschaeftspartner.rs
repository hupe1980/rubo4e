...
impl crate::Bo4eStrict for Geschaeftspartner {
    fn collect_unknown_enums(&self, path: &str, out: &mut Vec<String>) {
        if let Some(v) = &self.adresse {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "adresse"),
                out,
            );
        }
        if let Some(v) = &self.anrede {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "anrede"),
                out,
            );
        }
        if let Some(items) = &self.ansprechpartner {
            let child = crate::strict::field_path(path, "ansprechpartner");
        ...
        if let Some(items) = &self.geschaeftspartnerrollen {
            let child = crate::strict::field_path(path, "geschaeftspartnerrollen");
            for (i, item) in items.iter().enumerate() {
                crate::Bo4eStrict::collect_unknown_enums(
                    item,
                    &crate::strict::index_path(&child, i),
        ...
        if let Some(items) = &self.kontaktwege {
            let child = crate::strict::field_path(path, "kontaktwege");
            for (i, item) in items.iter().enumerate() {
                crate::Bo4eStrict::collect_unknown_enums(
                    item,
                    &crate::strict::index_path(&child, i),
        ...
        if let Some(v) = &self.organisationstyp {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "organisationstyp"),
                out,
            );
        }
        if let Some(v) = &self.titel {
            crate::Bo4eStrict::collect_unknown_enums(
                v,
                &crate::strict::field_path(path, "titel"),
                out,
            );
        }
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Geschaeftspartner {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Geschaeftspartner {
