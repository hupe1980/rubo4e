use super::{Bo4eComponent, Bo4eTyped, ComTyp, Landescode, ZusatzAttribut};
...
impl Bo4eTyped for Adresse {
    type Typ = ComTyp;
    const TYP: ComTyp = ComTyp::Adresse;
    const TYP_WIRE: &'static str = "ADRESSE";
    const SCHEMA_VERSION: &'static str = "202607.1.0";
    const SCHEMA_SERIES: &'static str = "202607";
}
impl crate::bo4e_typed_sealed::Sealed for Adresse {}
impl Bo4eComponent for Adresse {}
impl crate::bo4e_component_sealed::Sealed for Adresse {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensions for Adresse {
...
impl crate::zusatz_attribut::HasZusatzAttribute for Adresse {
