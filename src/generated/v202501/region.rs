use super::{Bo4eObject, BoTyp, Regionskriterium, ZusatzAttribut};
...
///
/// > **Note:** [Region JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/bo/Region.json)
pub struct Region {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "negativListe"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(strip_option)))]
    pub negativ_liste: Option<Vec<Regionskriterium>>,
    /// Positivliste der Kriterien zur Definition der Region
    #[cfg_attr(feature = "serde", serde(rename = "positivListe"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(strip_option)))]
    pub positiv_liste: Option<Vec<Regionskriterium>>,
...
impl Default for Region {
    fn default() -> Self {
        Self {
            ...
            id: Default::default(),
            negativ_liste: Default::default(),
            positiv_liste: Default::default(),
