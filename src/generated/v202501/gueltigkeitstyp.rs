...
pub enum Gueltigkeitstyp {
    #[cfg_attr(feature = "serde", serde(rename = "NUR_IN"))]
    #[cfg_attr(feature = "strum", strum(serialize = "NUR_IN"))]
    NurIn,
    #[cfg_attr(feature = "serde", serde(rename = "NICHT_IN"))]
    #[cfg_attr(feature = "strum", strum(serialize = "NICHT_IN"))]
    NichtIn,
    #[cfg_attr(feature = "serde", serde(rename = "NUR_IN_KOMBINATION_MIT"))]
    #[cfg_attr(feature = "strum", strum(serialize = "NUR_IN_KOMBINATION_MIT"))]
    NurInKombinationMit,
...
impl Gueltigkeitstyp {
    /// Returns an iterator over all **known** variants of `Gueltigkeitstyp`.
    ///
    /// Unlike [`strum::IntoEnumIterator`] which includes the [`Gueltigkeitstyp::Unknown`]
    ...
    /// # Example
    /// ```rust,ignore
    /// for v in Gueltigkeitstyp::iter_known() {
    ///     println!("{v}");
    /// }
    /// ```
    #[cfg(feature = "strum")]
...
impl sqlx::Type<sqlx::Postgres> for Gueltigkeitstyp {
...
impl<'q> sqlx::Encode<'q, sqlx::Postgres> for Gueltigkeitstyp {
    fn encode_by_ref(
        &self,
...
#[cfg(all(feature = "sqlx", feature = "json"))]
impl<'r> sqlx::Decode<'r, sqlx::Postgres> for Gueltigkeitstyp {
    fn decode(
...
impl proptest::arbitrary::Arbitrary for Gueltigkeitstyp {
    type Parameters = ();
