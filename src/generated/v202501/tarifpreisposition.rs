use super::{
    ComTyp, Mengeneinheit, Preisstaffel, Preistyp, Waehrungseinheit, ZusatzAttribut,
};
...
///
/// > **Note:** [Tarifpreisposition JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/Tarifpreisposition.json)
