...
///
/// > **Note:** [AufAbschlagRegional JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/AufAbschlagRegional.json)
pub struct AufAbschlagRegional {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "betraege"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub betraege: Option<Vec<AufAbschlagProOrt>>,
...
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for AufAbschlagRegional {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for AufAbschlagRegional {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl std::fmt::Display for AufAbschlagRegional {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<AufAbschlagRegional: serialization error: {e}>"),
        }
    }
}
