use super::{Bo4eObject, BoTyp, Lokationstyp, Verbrauch, ZusatzAttribut};
...
///
/// > **Note:** [Energiemenge JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/bo/Energiemenge.json)
...
impl Default for Energiemenge {
    fn default() -> Self {
        Self {
            ...
            energieverbrauch: Default::default(),
            id: Default::default(),
            lokations_id: Default::default(),
            lokationstyp: Default::default(),
