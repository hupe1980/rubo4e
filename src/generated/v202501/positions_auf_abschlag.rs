use super::{AufAbschlagstyp, ComTyp, Waehrungseinheit, ZusatzAttribut};
...
///
/// > **Note:** [PositionsAufAbschlag JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/PositionsAufAbschlag.json)
pub struct PositionsAufAbschlag {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "aufAbschlagswaehrung"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub auf_abschlagswaehrung: Option<Waehrungseinheit>,
    /// Höhe des Auf-/Abschlages
    #[cfg_attr(feature = "serde", serde(rename = "aufAbschlagswert"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    #[cfg(feature = "decimal")]
    pub auf_abschlagswert: Option<rust_decimal::Decimal>,
    ...
    pub auf_abschlagswert: Option<String>,
...
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for PositionsAufAbschlag {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for PositionsAufAbschlag {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for PositionsAufAbschlag {
...
#[cfg(feature = "json")]
impl std::fmt::Display for PositionsAufAbschlag {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<PositionsAufAbschlag: serialization error: {e}>"),
        }
    }
}
