...
///
/// > **Note:** [Tarifinfo JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/bo/Tarifinfo.json)
pub struct Tarifinfo {
    ...
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(BoTyp::Tarifinfo), setter(skip))
    )]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Tarifinfo {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl std::fmt::Display for Tarifinfo {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Tarifinfo: serialization error: {e}>"),
        }
    }
}
