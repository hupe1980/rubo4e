use super::{ComTyp, Steuerkennzeichen, Waehrungscode, ZusatzAttribut};
...
///
/// > **Note:** [Steuerbetrag JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/Steuerbetrag.json)
pub struct Steuerbetrag {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "steuerkennzeichen"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub steuerkennzeichen: Option<Steuerkennzeichen>,
