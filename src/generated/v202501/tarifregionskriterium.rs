...
pub enum Tarifregionskriterium {
    #[cfg_attr(feature = "serde", serde(rename = "NETZ_NUMMER"))]
    #[cfg_attr(feature = "strum", strum(serialize = "NETZ_NUMMER"))]
    NetzNummer,
    ...
    Ort,
    #[cfg_attr(feature = "serde", serde(rename = "GRUNDVERSORGER_NUMMER"))]
    #[cfg_attr(feature = "strum", strum(serialize = "GRUNDVERSORGER_NUMMER"))]
...
impl Tarifregionskriterium {
    /// Returns an iterator over all **known** variants of `Tarifregionskriterium`.
    ///
    /// Unlike [`strum::IntoEnumIterator`] which includes the [`Tarifregionskriterium::Unknown`]
    ...
    /// # Example
    /// ```rust,ignore
    /// for v in Tarifregionskriterium::iter_known() {
    ///     println!("{v}");
    /// }
    /// ```
    #[cfg(feature = "strum")]
...
impl sqlx::Type<sqlx::Postgres> for Tarifregionskriterium {
...
impl<'q> sqlx::Encode<'q, sqlx::Postgres> for Tarifregionskriterium {
    fn encode_by_ref(
        &self,
...
#[cfg(all(feature = "sqlx", feature = "json"))]
impl<'r> sqlx::Decode<'r, sqlx::Postgres> for Tarifregionskriterium {
    fn decode(
...
impl proptest::arbitrary::Arbitrary for Tarifregionskriterium {
    type Parameters = ();
