...
#[cfg_attr(
    ...
    garde(custom(crate::validation::v202501::validate_vertrag_dates))
)]
...
///
/// > **Note:** [Vertrag JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/bo/Vertrag.json)
pub struct Vertrag {
    ...
    #[cfg_attr(
        feature = "builder",
        builder(default = Some(BoTyp::Vertrag), setter(skip))
    )]
...
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for Vertrag {}
#[cfg(feature = "json")]
...
#[cfg(feature = "json")]
impl std::fmt::Display for Vertrag {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<Vertrag: serialization error: {e}>"),
        }
    }
}
