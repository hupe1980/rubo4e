use super::{ComTyp, RegionaleGueltigkeit, Sigmoidparameter, ZusatzAttribut};
...
///
/// > **Note:** [RegionalePreisstaffel JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/RegionalePreisstaffel.json)
pub struct RegionalePreisstaffel {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "einheitspreis"))]
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    #[cfg(feature = "decimal")]
    pub einheitspreis: Option<rust_decimal::Decimal>,
    ...
    pub einheitspreis: Option<String>,
    ...
    #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
    #[cfg_attr(feature = "builder", builder(default, setter(into)))]
    pub regionale_gueltigkeit: Option<RegionaleGueltigkeit>,
...
#[cfg(feature = "json")]
impl crate::json::sealed::Sealed for RegionalePreisstaffel {}
#[cfg(feature = "json")]
impl crate::json::Bo4eJsonExt for RegionalePreisstaffel {}
#[cfg(feature = "json")]
impl crate::json::Bo4eExtensionData for RegionalePreisstaffel {
...
#[cfg(feature = "json")]
impl std::fmt::Display for RegionalePreisstaffel {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match serde_json::to_string(self) {
            Ok(json) => f.write_str(&json),
            Err(e) => write!(f, "<RegionalePreisstaffel: serialization error: {e}>"),
        }
    }
}
