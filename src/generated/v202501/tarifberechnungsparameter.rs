use super::{
    ComTyp, Messpreistyp, Preis, Tarifkalkulationsmethode, Tarifpreis, ZusatzAttribut,
};
...
///
/// > **Note:** [Tarifberechnungsparameter JSON Schema](https://json-schema.app/view/%23?url=https://raw.githubusercontent.com/BO4E/BO4E-Schemas/v202501.0.0/src/bo4e_schemas/com/Tarifberechnungsparameter.json)
