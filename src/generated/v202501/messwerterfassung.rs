...
#[non_exhaustive]
pub enum Messwerterfassung {
    #[cfg_attr(feature = "serde", serde(rename = "FERNAUSLESBAR"))]
    #[cfg_attr(feature = "strum", strum(serialize = "FERNAUSLESBAR"))]
    Fernauslesbar,
    #[cfg_attr(feature = "serde", serde(rename = "MANUELL_AUSGELESENE"))]
    #[cfg_attr(feature = "strum", strum(serialize = "MANUELL_AUSGELESENE"))]
    ManuellAusgelesene,
...
impl Messwerterfassung {
    /// Returns an iterator over all **known** variants of `Messwerterfassung`.
    ///
    /// Unlike [`strum::IntoEnumIterator`] which includes the [`Messwerterfassung::Unknown`]
    ...
    /// # Example
    /// ```rust,ignore
    /// for v in Messwerterfassung::iter_known() {
    ///     println!("{v}");
    /// }
    /// ```
    #[cfg(feature = "strum")]
...
impl sqlx::Type<sqlx::Postgres> for Messwerterfassung {
...
impl<'q> sqlx::Encode<'q, sqlx::Postgres> for Messwerterfassung {
    fn encode_by_ref(
        &self,
...
#[cfg(all(feature = "sqlx", feature = "json"))]
impl<'r> sqlx::Decode<'r, sqlx::Postgres> for Messwerterfassung {
    fn decode(
...
impl proptest::arbitrary::Arbitrary for Messwerterfassung {
    type Parameters = ();
